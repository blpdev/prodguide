            ...
            defaults = {
                ...
                events: {
                    ...
                    onCompleteQuiz: function (options) {}  // reserved: options.questionCount, options.score
					 ...
					 timer_time: ( 90),    //  The default time of the timer
            ...
            checkAnswer: function(checkButton, options) {
                ...
                kN = keyNotch; // you specify the notch, you get a callback function for your animation
					...
					if($(checkButton).data('questiontype') == 'text'){
						...
						var textAnswer      = $('#slickQuiz_question').val();
						var questionIndex   = parseInt(questionLI.attr('id').replace(/(question)/, ''), 10);
						var answers         = questions[questionIndex].a[0].option.toString().toLowerCase();
